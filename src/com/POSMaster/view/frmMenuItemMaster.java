        ...
        try
        {
            ...
            else
            {
                ...
                updateQuery = "Update tblitemmaster SET strItemName=? ,strSubGroupCode=? ,"
                        ...
                        + ",imgImage=?,tmeTargetMiss=?,strRecipeUOM=?,dblReceivedConversion=?,dblRecipeConversion=?,strHSNNo=?  "
                        + "WHERE strItemCode =? ";
                ...
                pre.setString(40, txtItemCode.getText());
            ...
            .addGroup(panelGeneralLayout.createSequentialGroup()
                ...
                .addGroup(panelGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelGeneralLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(panelGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(chkRawMaterial, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lblSubGroupCode, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(panelGeneralLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(chkItemForSale, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(panelGeneralLayout.createSequentialGroup()
...
//                bttImage.setIcon(new ImageIcon(imagePath));
    ...
    private void btnNewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNewMouseClicked
        ...
        if (!objUtility.funCheckDouble(txtMinlevel.getText()))
        {
            JOptionPane.showMessageDialog(this, "Invaild Input Minlevel");
            return;
        }
        if (!objUtility.funCheckDouble(txtMaxlevel.getText()))
        {
            JOptionPane.showMessageDialog(this, "Invaild Input Maxlevel");
            return;
        }
        ...
        if (Double.parseDouble(txtMinlevel.getText()) > Double.parseDouble(txtMaxlevel.getText()))
        {
            JOptionPane.showMessageDialog(this, "Invaild Maxlevel Value");
            return;
        }
        funSaveAndUpdate();
